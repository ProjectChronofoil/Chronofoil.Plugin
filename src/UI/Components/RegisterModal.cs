...
public class RegisterModal : Window, IAuthListener
{
    ...
    {
        ImGui.TextWrapped("Chronofoil registration is only necessary if you would like to contribute packet captures to the central capture repository.");
        ImGui.TextWrapped("Registration is not necessary for capturing packets for your own purposes.");
        ImGui.TextWrapped("Please read the terms and conditions carefully. It contains important information regarding your privacy as a Chronofoil user.");
    ...
    private void DrawError()
    {
        ...
        ImGui.InputTextMultiline("##cf_register_error", ref _errorText, _errorText.Length, BoxSize, ImGuiInputTextFlags.ReadOnly);
